...
def section_box(title: str, empty_state_message: str) -> toga.Box:
    ...
    """
    heading = toga.Label(title, style=Pack(font_size=20, font_weight="bold", margin_bottom=8))
    message = toga.Label(empty_state_message, style=Pack(margin_bottom=4))
    return toga.Box(
        children=[heading, message],
        style=Pack(direction=COLUMN, margin=SECTION_PADDING, flex=1),
    )
